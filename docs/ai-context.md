...
- Compiler type model: AST/parser/type-checker use `TypeRef`; named object types now resolve via an object symbol table (fields + forward refs). Constructor/method symbols are not implemented yet.
...
## Not Implemented (yet)
- User-defined data runtime: object construction/instances, methods, records, interfaces, visibility enforcement.
