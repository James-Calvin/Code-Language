...
- Object rules: fields require constructor initialization; constructor overloads are arity-based; reserved field names are `length`, `hasValue`, `value`, `or`.
...
## Not Implemented (yet)
- User-defined data remaining: methods, records, interfaces, visibility enforcement.
